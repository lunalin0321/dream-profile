...
- `白圖跟隨重點色 / 白圖使用自選色`：適合白色剪影、白色符號。夢角 icon 會跟著該夢角重點色；社群 icon 可以在後台自己選顏色。
...
- 如果單純坑沒有要填主推、副推或吃 CP，可以只寫作品與備註，例如：`作品名｜｜｜｜只當坑單記錄`。首頁會只顯示備註，不會出現空的欄位。
- 可以新增分類、刪除分類、上下移動。
...
- 說明會顯示在主頁的社群卡片裡。
- 首頁上方的「發送訊息」會跳到 `Social Links` 區塊，讓訪客自己選要用哪個平台聯絡。
- icon 可以在後台下拉選單修改。
